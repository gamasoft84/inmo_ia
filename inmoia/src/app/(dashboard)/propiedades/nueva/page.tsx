...
export default function NuevaPropiedadPage() {
  ...
  function handleAIOnboarding(result: AIOnboardingResult) {
    setForm((prev) => ({
      ...
      amenities:        result.amenities?.length ? result.amenities : prev.amenities,
      title_es:         result.title_es || prev.title_es,
      title_en:         result.title_en || prev.title_en,
      desc_es:          result.desc_es  || prev.desc_es,
      desc_en:          result.desc_en  || prev.desc_en,
      desc_whatsapp_es: result.desc_whatsapp_es || prev.desc_whatsapp_es,
      desc_instagram_es:result.desc_instagram_es || prev.desc_instagram_es,
    ...
    try {
      ...
      const response = await fetch("/api/properties/publish", {
        ...
        body: JSON.stringify({
          ...
          desc_whatsapp_es:  form.desc_whatsapp_es,
          desc_instagram_es: form.desc_instagram_es,
